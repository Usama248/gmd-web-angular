...
export const routes: Routes = [
  ...
  {
    path: 'clinic',
    canActivate: [authGuard, isClinicGuard, userStateGuard],
    ...
    children: [
      ...
      { path: 'payment', canActivate:[isClinicOwnerGuard], title: 'Payment Due', loadComponent: () => import('./pages/payment-due/payment-due.component').then(x => x.PaymentDueComponent) },
